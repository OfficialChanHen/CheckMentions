...
UNIVERSE: List[Company] = [
    ...
    Company("GD", "General Dynamics", "Phebe Novakovic", "Defense",
            ["Electric Boat", "General Dynamics Electric Boat", "Bath Iron Works",
             "General Dynamics Information Technology", "GDIT", "Gulfstream Aerospace"],
            products=["Abrams", "Virginia-class", "Columbia-class"]),
    ...
    Company("KTOS", "Kratos", "Eric DeMarco", "Defense",
            ["Kratos Defense", "Kratos Defense & Security Solutions"],
            products=["XQ-58A Valkyrie", "Valkyrie drone"]),
    Company("PSN", "Parsons", "Carey Smith", "Defense", ["Parsons Corporation"]),
    Company("LHX", "L3Harris", "Chris Kubasik", "Defense",
            ["L3Harris Technologies", "L3 Harris", "Harris Corporation",
             "L-3 Communications", "L3Harris Technologies, Inc."]),
    Company("TXT", "Textron", "Scott Donnelly", "Defense",
            ["Textron Inc", "Bell Textron", "Bell Helicopter", "Textron Aviation",
             "Bell Textron Inc"],
            products=["V-22 Osprey", "Bell V-280", "Bell H-1"]),
